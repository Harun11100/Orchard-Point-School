            ...
            onPress: async () => {
              try {
                ...
                if (data.success) {
                  ...
                  Alert.alert("সফল", " মুছে ফেলা হয়েছে।");
                } else {
  ...
  return (
    <LinearGradient colors={["#EEF2FF", "#F8FAFC"]} style={{ flex: 1 }}>
      ...
      <View style={styles.header}>
        ...
        <Text style={styles.subHeader}>বিভিন্ন পুরস্কার ও অর্জনসমূহ</Text>
      </View>
      ...
      <FlatList
              ...
              <View style={styles.infoContainer}>
                ...
                <Text style={styles.dateText}>
                 ...
                 <TouchableOpacity
                  ...
                  >
                  <MaterialIcons name="delete" size={22} color="#fd5f5fff" />
                  </TouchableOpacity>
              </View>
            </LinearGradient>
          </TouchableOpacity>
        ...
        ListEmptyComponent={() =>
          fetching ? (
            <ActivityIndicator size="large" color="#3b6cd7ff" style={{ marginTop: 60 }} />
          ) : (
